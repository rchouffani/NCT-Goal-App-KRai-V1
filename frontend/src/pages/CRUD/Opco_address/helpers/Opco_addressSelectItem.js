...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/opco_address/autocomplete`, { params });
  return response.data;
}

const Opco_addressSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.opco_address.hasPermissionToCreate,
});

export default connect(select)(Opco_addressSelectItem);
