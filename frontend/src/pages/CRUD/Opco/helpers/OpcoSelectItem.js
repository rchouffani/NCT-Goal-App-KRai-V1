...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/opco/autocomplete`, { params });
  return response.data;
}

const OpcoSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.opco.hasPermissionToCreate,
});

export default connect(select)(OpcoSelectItem);
