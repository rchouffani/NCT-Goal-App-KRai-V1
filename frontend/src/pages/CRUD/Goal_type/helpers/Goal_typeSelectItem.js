...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/goal_type/autocomplete`, { params });
  return response.data;
}

const Goal_typeSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.goal_type.hasPermissionToCreate,
});

export default connect(select)(Goal_typeSelectItem);
